...
class DashboardContainer extends React.Component {
  ...
  constructor (props) {
    ...
    this.itemsOnEdit = this.itemOnEdit.bind(this);
...
DashboardContainer.propTypes = {
  dashboardVisitIncrement: React.PropTypes.fun,
  dashboard: React.PropTypes.Object,
  dashboardEditItem: React.PropTypes.fun,
  dashboardAddItem: React.ProtoTypes.fun
};
